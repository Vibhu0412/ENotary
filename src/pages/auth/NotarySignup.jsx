...
// import Illustration from "@/assets/images/auth/eidos_1.png";
// import Illustration from "@/assets/images/auth/eidos_2.png";
// import Illustration from "@/assets/images/auth/eidos_3.png";

import Card from '../../components/ui/Card';
import NotarySignupForm from './common/NotarySignupForm';
              ...
              >
                <Card className="p-[2.5rem] shadow-xl">
                  <div className="text-center 2xl:mb-10 mb-5">
                    <h4 className="font-medium">Register as Notary</h4>
                  </div>
                  <NotarySignupForm />

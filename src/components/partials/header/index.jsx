...
const Header = (user, { className = "custom-class" }) => {
  // console.log("in header page ", user);
  ...
  return (
    <header className={className + " " + navbarTypeClass()}>
      <div
        className={` app-header md:px-6 px-[15px]  dark:bg-slate-800 shadow-base dark:shadow-base3 bg-slate-500
        ${borderSwicthClass()}
             ${
